/**
 * ObjectList Class
 * Description: Contains methods in order to create lists
 * @author Prof
 */
...
public class ObjectList implements ObjectListInterface{
     ...
     *  @param o object that is being added to the front
     */
     ...
     *  @param p node being added to the front
     */
    ...
    *  @param o object being added to the end
    */
     ...
     *  @param p node being added to the end
     */
     ...
     *  @return info for first object from list
     */
     ...
     *  @return info for last object from list
     */
     ...
     *  @return null or object remove info
     */
     ...
     *  @param o item being looked for
     *  @return boolean based on item found
     */
     ...
     *  @return boolean based on if empty
     */
